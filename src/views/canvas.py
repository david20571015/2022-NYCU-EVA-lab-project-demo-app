...
class PaintScene(QGraphicsScene):
    ...
    def hide_pen_preview(self):
        self._cursor_outline.hide()
        self._cursor_fill.hide()

    def show_pen_preview(self):
        self._cursor_outline.show()
        self._cursor_fill.show()
...
class PaintView(QGraphicsView):
    ...
    """
    def __init__(self, width = 256, height = 256, *args, **kwargs, ):
    ...
    def enterEvent(self, event):
        ...
        self.scene().show_pen_preview()

    def leaveEvent(self, event):
        super().leaveEvent(event)
        self.scene().hide_pen_preview()
...
class DeleteStroke(QUndoCommand):
    """
    Removes stroke from paint scene
    """
    ...
    def undo(self):
        ...
        if self._group:
            ...
            # layer_data = self._stroke.data(1,QtCore.Qt.UserRole)[0]
            layer_data = self._stroke.data(1,QtCore.Qt.UserRole)[0]
...
class DeleteGroup(QUndoCommand):
    """
...
class GroupStrokes(QUndoCommand):
    """
