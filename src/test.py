...
with Image.open('./model/img1.png') as left_img:
    left_image = TF.to_tensor(left_img)

with Image.open('./model/img2.png') as right_img:
...
save_image(outputs, './model/outputs.png')
...
save_image(pred_image, './model/pred_image.png')
